...
export default function AuthAbout() {
	return (
		<div className='flex flex-col items-center w-full md:items-start md:w-fit'>
			...
			<div className='relative mt-10 pb-25 md:pb-87.5 w-full'>
				...
				<div className='absolute w-42 h-50 md:w-59 md:h-75 rounded-2xl overflow-hidden shadow-2xl rotate-6 left-40 md:left-60 top-10 z-20 border-4 border-white'>
					<Image src={imageTwo} alt='Image two' fill className='object-cover' />
				</div>

				<div className='absolute w-42 h-50 md:w-59 md:h-75 rounded-2xl overflow-hidden shadow-2xl -rotate-2 left-20 md:left-30 -top-5 z-30 border-4 border-white'>
					<Image
						src={imageThree}
						alt='Image three'
						fill
